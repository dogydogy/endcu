...
(function (window) {
  ...
  CircleSlideshow.prototype._init = function () {
    ...
    this.navLeftCtrl.innerHTML = '<span class="material-icons navbutton__line b-right">arrow_forward_ios</span>';
    ...
    this.navRightCtrl.innerHTML = '<span class="material-icons navbutton__line b-left">arrow_forward_ios</span>';
  ...
  CircleSlideshow.prototype._navigate = function (dir) {
    ...
    dynamics.animate(
      currentEl,
      {
        translateX: dir === "right" ? -1 * currentEl.offsetWidth : currentEl.offsetWidth,
        scale: 0.7,
      },
      {
  ...
  CircleSlideshow.prototype._moveCircles = function (dir) {
    ...
    dynamics.animate(
      this.circles.right,
      {
        translateX: dir === "right" ? -this.circles.right.offsetWidth / 3 : this.circles.right.offsetWidth / 3,
        scale: 0.9,
      },
      animProps
    );
    dynamics.animate(
      this.circles.left,
      {
        translateX: dir === "right" ? -this.circles.left.offsetWidth / 3 : this.circles.left.offsetWidth / 3,
        scale: 0.9,
      },
      animProps
    );
...
let hoImageList = [
  {id: 0, src: "img/storycu.png"},
  {id: 1, src: "img/storycu2.png"},
  {id: 2, src: "img/storycu3.png"},
  {id: 3, src: "img/storycu4.png"},
]

// 커스텀
let inner = document.querySelectorAll(".slide__inner");
let slidelink = document.querySelectorAll(".slide__link");
// let hocon = documnet.querySelector(".ho-con")

slidelink.forEach((v, idx) => {
  let image = document.createElement("img");
  image.classList = "ho-con";
  hoImageList.filter(v => v.id === idx ? image.src = v.src : "")
